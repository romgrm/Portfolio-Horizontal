...
document.querySelector('.darkButton').addEventListener('click', () => {
    ...
    document.querySelector('.square:hover span:nth-child(1)').classList.toggle('dark')
...
document.querySelector('.square:hover span:nth-child(1)').addEventListener(onmouseover, () => {
    document.querySelector('.square:hover span:nth-child(1)').classList.toggle('dark')
