...
button.addEventListener('click', () => {
    ...
    const content = document.getElementById('darkMode').innerHTML;
    document.getElementById('darkMode').innerHTML = content == 'light' ? 'dark' : 'light';
    ...
    document.querySelectorAll('.gallery__item-link, .gallery__item-link').forEach(elem => {
        elem.classList.toggle('dark')
    })
