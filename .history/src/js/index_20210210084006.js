...
button.addEventListener('click', () => {
    ...
    document.querySelectorAll('.gallery__content-project h2').classList.toggle('dark')
    document.querySelectorAll('.gallery__content-project p').classList.toggle('dark')
    document.querySelector('.gallery__item-imginner1').classList.toggle('dark')
    document.querySelector('.square span:nth-child(1)').classList.toggle('dark')
    document.querySelector('.square span:nth-child(2)').classList.toggle('dark')
    document.querySelector('.square span:nth-child(3)').classList.toggle('dark')
