...
button.addEventListener('click', function () {
  var content = document.getElementById('darkMode').innerHTML;
  document.getElementById('darkMode').innerHTML = content == 'light' ? 'dark' : 'light'; // document.querySelector('a').classList.toggle('dark')
  ...
  document.querySelectorAll('.gallery__content-project p').forEach(function (elem) {
    elem.classList.toggle('dark');
  });
  document.querySelectorAll('.square span:nth-child(1)').forEach(function (elem) {
    elem.classList.toggle('dark');
  });
  document.querySelectorAll('.square span:nth-child(2)').forEach(function (elem) {
    elem.classList.toggle('dark');
  });
  document.querySelectorAll('.square span:nth-child(3)').forEach(function (elem) {
    elem.classList.toggle('dark');
  });
  document.querySelectorAll('.content-stack').forEach(function (elem) {
    elem.classList.toggle('dark');
  });
  document.querySelectorAll('.square:hover .content-stack').forEach(function (elem) {
    elem.classList.toggle('dark');
  });
  document.querySelector('.gallery__item-stack').classList.toggle('dark');
  document.querySelectorAll('.gallery__item-link').forEach(function (elem) {
    elem.classList.toggle('dark');
  });
  document.querySelectorAll('.gallery__item-link:focus, .gallery__item-link:hover').forEach(function (elem) {
    elem.classList.toggle('dark');
  });
  document.querySelectorAll('.buttonNavBar').forEach(function (elem) {
    elem.classList.toggle('dark');
...
// }
},{"./utils":"MgTz","./cursor":"LMRJ","locomotive-scroll":"ez7q"}]},{},["QvaY"], null)